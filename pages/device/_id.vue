<template>
  ...
  <b-container fluid>
    <b-row class="p-0 " >
      <b-col >
        <b-card> <!--  overlay img-src="https://picsum.photos/1024/480/?image=1035&blur=5"-->
          <b-card-body>
              <h3 class="mb-3 text-center">Uses</h3>
              <usesmonthchart class="mh-10"/>
              <h3 class="mb-3 text-center">Fluid</h3>
              <fluidmonthchart class=""/>
          </b-card-body>
        </b-card>
      </b-col>
    </b-row>
